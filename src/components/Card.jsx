...
const Card = ({ card }) => {
    ...
    return (
        <div className="card relative bg-base-100 shadow-xl border-2 transition-all duration-500 hover:scale-95 hover:border-pink-400">
            ...
            <div data-aos="zoom-in-down" data-aos-duration="1000" className="absolute w-48 bg-green-100 bottom-[385px] md:border-l-4  md:border-l-red-400  md:rounded-tr-2xl pl-2 py-2 md:-left-5 rounded-l-md ">
