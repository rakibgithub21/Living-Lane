...
const Card = ({ card }) => {
    console.log(card)
    const { id, image_url, segment_name, nearby_attractions, description, price, status, location, } = card
    return (
        <div className="card relative bg-base-100 shadow-xl border-2 transition-all duration-500 hover:scale-95 hover:border-pink-400">
            ...
            <div className="card-body">
                <div className="space-y-4">
                    ...
                    <hr />
                    <p className=" font-medium raleway">
            ...
            <div data-aos="zoom-in-down" data-aos-duration="1000" className="absolute w-48 bg-green-100 bottom-[248px] md:border-l-4  md:border-l-red-400  md:rounded-tr-2xl pl-2 py-2 md:-left-5 rounded-l-md ">
