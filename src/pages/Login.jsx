            ...
            <div className="w-full md:w-4/6 lg:w-3/6 mx-auto p-8 space-y-3 rounded-xl dark:bg-gray-50 dark:text-gray-800">
                ...
                <div className="flex justify-center  space-x-4">
                    ...
                    <button onClick={loginWithGoogle} aria-label="Log in with Google" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-9  h-9 fill-current animate__animated animate__heartBeat animate__infinite">
                    ...
                    <button onClick={loginWithGithub} aria-label="Log in with GitHub" className="p-3 rounded-sm">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-9 animate__animated animate__heartBeat animate__infinite h-9 fill-current">
